...
export const primaryButtonClasses = "px-6 font-semibold border-2 border-black bg-green text-whitesmoke disabled:bg-whitesmoke disabled:text-gray-med disabled:border-1 hover:cursor-pointer";
